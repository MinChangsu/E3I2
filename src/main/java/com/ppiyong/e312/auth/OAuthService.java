...
public class OAuthService extends DefaultOAuth2UserService {
    ...
    public PrincipalDetails loadUserKaKao(KakaoUserInfo kakaoUserInfo) throws OAuth2AuthenticationException {

        System.out.println("로드유저2실행");

        OAuth2UserInfo oAuth2UserInfo = kakaoUserInfo;
